 ...
 */
class DealTnRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, DealTn::class);
    }
    ...
    public function createDealTNBD(
        string $orderId,
        string $leadId,
        string $clientId,
        string $status,
     ...
     */
    public function updateStageTn($deal, $stage)
    {
    ...
    public function createDealTNFromBitrix(
        string $clientId,
        string $status,
        string $bitrixId,
        string $offerId,
